...
function Sidebar() {
  ...
  return (
    <div style={{
      ...
      padding: '20px 0', gap: '6px', minHeight: '100vh',
...
function Topbar({ title }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        flex: 1, maxWidth: '340px', marginLeft: '20px', background: '#f4f6fd',
        borderRadius: '10px', display: 'flex', alignItems: 'center',
        gap: '8px', padding: '0 14px', height: '38px',
      }}>
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#9fa8c7" strokeWidth="2.5">
      ...
      <div style={{ position: 'relative' }}>
        <div style={{
          width: '38px', height: '38px', borderRadius: '10px',
          background: '#fff8e6', display: 'flex', alignItems: 'center',
...
function AppShell() {
  ...
  const title = loc.pathname === '/dashboard' ? 'Dashboard'
    : loc.pathname === '/predict' ? 'Predict Segment' : 'Upload Data';
  return (
